...
def extract_r40(log_path, label):
    ...
    try:
        ...
        if start_idx != -1:
            ...
            # print(f"Found results for: {epoch_line}") # Optional debug
            
            # Print specifically the R40 lines
            # Structure: 
            # Car AP_R40...
            # bbox ...
            # bev ...
...
def main():
    logs = [
        (r'c:\Users\yanbo\Downloads\Papers\uncertainty_painting\OpenPCDet\output\kitti_models\pointpillar_painted\default\train_20251205-100116.log', 'PointPillars (With Uncertainty)'),
