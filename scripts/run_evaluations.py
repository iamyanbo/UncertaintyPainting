...
def main():
    ...
    # Format: (Checkpoint Path, Config Path, Tag Name)
    models = [
        (
            ...
            "pointpillar_painted.yaml", # Need to check if this is the correct config name
        ...
        (
            ...
            "pointpillar_painted_no_uncertainty.yaml",
        ...
        (
            ...
            "second_painted.yaml", # Checking this name
